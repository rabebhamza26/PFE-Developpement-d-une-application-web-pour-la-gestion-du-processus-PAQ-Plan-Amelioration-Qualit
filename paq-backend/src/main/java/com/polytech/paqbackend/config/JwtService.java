...
public class JwtService {
    ...
    public String generateToken(User user) {
        ...
        claims.put("fullName", user.getNomUtilisateur());
        claims.put("userId", user.getId());
        return buildToken(claims, user.getLogin(), jwtExpiration);
    }

    public String generateRefreshToken(User user) {
        return buildToken(new HashMap<>(), user.getLogin(), refreshExpiration);
    }
